...
The objective to find 'Beta' parameters of Linear Regression equation for both Simple and Multiple Linear Regression techniques.
...
```{r}
ads <- read.csv("E:/PhD/Pattern Recognition/Assigment 01/Advertising.csv", stringsAsFactors=FALSE)
